...
const help = {
  ...
  about: `<h2>Cinco formas de seguir al byte.</h2><p>Laboratorio educativo independiente para Sistemas Operativos, Ingeniería en Informática, FIUBA. Sin afiliación institucional.</p><p>Elegí Paginación x86 de 32 bits, Paginación con TLB, Segmentación, RISC-V/xv6 o Paginación x86-64. Cada simulación tiene estado, guía y fundamento propios.</p>`,
};
