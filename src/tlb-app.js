...
const help = {
  ...
  about: `<h2>Dos formas de seguir al byte.</h2><p>Laboratorio educativo independiente para Sistemas Operativos, Ingeniería en Informática, FIUBA. Sin afiliación institucional.</p><p>Elegí Paginación para el recorrido clásico o Paginación con TLB para estudiar traducciones guardadas. Cada simulación tiene estado, guía y fundamento propios. Se usa el mismo mapa fijo IA-32, sin PAE, con páginas de 4 KiB y segmentación plana.</p>`,
};
