...
const help = {
  ...
  about: `<h2>Cuatro formas de traducir.</h2><p>Laboratorio educativo independiente para Sistemas Operativos, Ingeniería en Informática, FIUBA. Sin afiliación institucional.</p><p>Elegí Paginación x86, Paginación con TLB, Segmentación o RISC-V/xv6. Cada simulación tiene estado, guía, fundamento y modelo propios.</p>`,
};
